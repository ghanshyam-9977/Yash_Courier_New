...
<section class="container-fluid  border-bottom">
    <nav class="navbar navbar-expand-lg center-nav transparent navbar-light p-0">
        <div class="container flex-lg-row flex-nowrap align-items-center">
            <div class="navbar-brand w-100 pt-0">
                <a href="{{ url('/') }}">
                    <img class="logo" src="{{ settings()->logo_image }}" style="height: 80px; margin-top:10px;" width="120"  alt="Logo">
                </a>
            </div>
            ...
            <div class="navbar-other w-100 d-flex ms-auto auth-info">
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    @else
                        <li class="nav-item  " > 
                            <a href="{{ route('login') }}" class=" btn btn-dark auth-btn" >{{ __('levels.login') }}</a>
                        </li>
                        <li class="nav-item ml-2 " >
                            <a href="{{ route('merchant.sign-up') }}" class="btn btn-dark auth-btn" >{{ __('levels.register') }}</a>
                        </li>
                    @endif
