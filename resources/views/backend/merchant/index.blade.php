                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @endif
                                                      {{-- ✅ New Feature: Download All Merchant Parcels --}}
                                                            <a href="{{ route('merchant.parcel.download', $merchant->id) }}" class="dropdown-item">
                                                                <i class="fa fa-download" aria-hidden="true"></i> Download All Parcels
                                                            </a>
