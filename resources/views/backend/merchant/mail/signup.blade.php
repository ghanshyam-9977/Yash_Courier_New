        ...
        <table style="width:100%;height:50px;max-width:650px;margin: auto;background-color: white;">
                <tr>
                    <td style="padding:30px;line-height: 1.5;" colspan="2">
                        ...
                        <p style="color: #bf040a;font-weight: bold;">Your Business Information :</p>
                        ...
                        <p>Please login your panel
                            ...
                            style="background-color: #bf040a;color: white; margin-left:10px;padding: 7px 15px; border: none;text-decoration: none;border-radius: 3px;"
                            >Login</a>
                        </p>
