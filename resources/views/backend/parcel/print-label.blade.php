                    ...
                    <td style="text-align:center!important"  >
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top:3px">
                            <div style="flex: 1; text-align: left;">
                                <div style="display: inline-block;">{!! $parcel->barcodeprint !!}</div>
                                <div style="font-size: 8px; margin-top: 2px;">{{ !empty($parcel->barcode) ? $parcel->barcode : $parcel->tracking_id }}</div>
                            </div>
                            <div style="flex: 0 0 auto; margin-left: 5px;">
                                <img src="{!! $parcel->qrcodeprint !!}" alt="QR Code" style="width: 50px; height: 50px;">
                            </div>
                        </div>
                    </td>
                </tr>
