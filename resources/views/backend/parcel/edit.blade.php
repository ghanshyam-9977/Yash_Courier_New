            ...
            <div class="col-md-12 col-lg-12 col-xl-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('parcel.update', $parcel) }}" method="POST" enctype="multipart/form-data"
                            id="basicform">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <select style="width: 100%" class="form-control select2" id="delivery_type_id"
                                        ...
                                        @foreach ($deliveryTypes as $key => $status)
                                            ...
                                            @elseif($status->key == 'by_road') value="5"
                                                @if ($parcel->delivery_type_id == 5) selected @endif @endif
                                            @elseif($status->key == 'by_air') value="6"
                                                @if ($parcel->delivery_type_id == 6) selected @endif @endif
                                                >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <textarea id="note" name="note" class="form-control" rows="10">{{ old('note', $parcel->note) }}</textarea>
                                    @error('note')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
