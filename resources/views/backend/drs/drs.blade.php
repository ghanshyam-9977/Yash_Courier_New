                ...
                <form method="GET" action="{{ route('drs.index') }}" class="row align-items-end">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="search" class="form-control"
                            placeholder="Search DRS No / Area / Delivery Boy" value="{{ request('search') }}">
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php
                                        ...
                                        $color = $statusColors[$drs->drs_status] ?? 'black';
                                    @endphp
                                ...
                                <td class="text-end">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{ route('drs.edit', $drs->id) }}">
                                                Update DRS
                                            </a>
                                    ...
                                    <form id="delete-form-{{ $drs->id }}"
                                        action="{{ route('drs.destroy', $drs->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
