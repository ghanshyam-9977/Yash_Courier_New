                        ...
                        <form action="{{ route('merchant-panel.parcel.store') }}" method="POST"
                                ...
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <select style="width: 100%" class="form-control select2" id="delivery_type_id"
                                        ...
                                        @foreach ($deliveryTypes as $key => $status)
                                            <option
                                                @if ($status->key == 'same_day') value="1" @elseif($status->key == 'next_day') value="2" @elseif($status->key == 'sub_city') value="3" @elseif($status->key == 'outside_City') value="4" @elseif($status->key == 'by_road') value="5" @elseif($status->key == 'by_air') value="6"   @endif >
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <div > <div id="googleMap" class="custom-map"></div> </div>
                                </div>
                                <div class="form-group col-12 col-md-6">
