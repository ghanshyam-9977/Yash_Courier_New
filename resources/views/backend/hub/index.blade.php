                        ...
                        <div class="row pl-4 pr-4 pt-4">
                            ...
                            <div class="col-6 d-flex justify-content-end align-items-center gap-2">
                                ...
                                @if (hasPermission('hub_create'))
                                    <a href="{{ route('hubs.create') }}" class="btn btn-primary btn-sm"
                                ...
                                <table class="table   ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Transport') }}</th>
                                            <th>{{ __('Slab') }}</th>
                                            <th>{{ __('State Wise chart prepar') }}</th>
                                            <th>{{ __('GST') }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($hubs as $hub)
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>Rate Slabs ({{ $hub->rateSlabs->count() }})</strong>

                                                    <ul class="mt-1">
                                                        @forelse($hub->rateSlabs as $slab)
                                                            <li>
                                                                {{ $slab->min_weight }}
                                                                -
                                                                {{ $slab->max_weight }}
                                                        ...
                                                        @empty
                                                            <li class="text-muted">No rate slabs</li>
                                                        @endforelse
                                                    </ul>
                                                </td>

                                                <td>
                                                    <strong>Service Areas
                                                        ({{ $hub->serviceAreas?->count() ?? 0 }})</strong>

                                                    <ul class="mt-1">
                                                        @forelse($hub->serviceAreas as $area)
                                                            <li>
                                                                {{ $area->state }}
                                                                @if ($area->city)
                                                                    - {{ $area->city }}
                                                        ...
                                                        @empty
                                                            <li class="text-muted">No service areas</li>
                                                        @endforelse
                                                    </ul>
                                                </td>
