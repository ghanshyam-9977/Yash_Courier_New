    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['middleware' => 'XSS'], function () {
            ...
            Route::group(['prefix' => 'admin'], function () {
                ...
                // routes/api.php
                // Route::get('/branches', [BranchController::class, 'getBranchesByCity']);
                // Route::get('/cities', [BranchController::class, 'getCitiesByState']);
                ...
                Route::post('/calculate-price', [ParcelController::class, 'calculatePrice']);

                Route::get('/hub-panel/payment-request', [PaymentRequestController::class, 'index'])->name('hub-panel.payment-request.index');
                Route::get('/hub-panel/branch-request', [HubController::class, 'index'])->name('hub-panel.branch-request.index');
                ...
                Route::get('/branch/estimate', [HubController::class, 'estimate'])->name('branch.estimate');
                Route::get('/branch/estimate-perday', [HubController::class, 'estimatePerDay'])->name('branch.estimate-perday');
                Route::get('/branch/estimate/Estimate-transaction', [HubController::class, 'parcelMultiplePrintLabelEstimateTransaction'])->name('branch.print-label-estimate-transaction');
                ...
                Route::get('/hubs/{id}/edit', [HubController::class, 'edit'])->name('hubs.edit');
                Route::get('hubs/create', [HubController::class, 'create'])->name('hubs.create')->middleware('hasPermission:hub_create');
                ...
                //units
                Route::get('Unit/create', [UnitController::class, 'create_unit'])->name('unit.create')->middleware('hasPermission:hub_create');
                Route::get('Unit/index', [UnitController::class, 'indexunit'])->name('unit.index')->middleware('hasPermission:hub_create');
                Route::post('Unit/store', [UnitController::class, 'store'])->name('unit.store')->middleware('hasPermission:hub_create');
                Route::get('Unit/edit/{id}', [UnitController::class, 'edit'])->name('unit.edit')->middleware('hasPermission:hub_update');
                Route::delete('Unit/delete/{id}', [UnitController::class, 'destroy'])->name('unit.destroy')->middleware('hasPermission:hub_delete');
                Route::put('/unit/{unit}', [UnitController::class, 'update'])->name('unit.update')->middleware('hasPermission:hub_update');


                // Route::put('payment-request/{id}', [HubPaymentRequestController::class, 'branchupdate'])->name('hub-panel.payment-request.update');
                ...
                //hub payment process
                Route::put('/hub-branch-payments/{payment}', [HubPaymentController::class, 'update'])->name('hub-branch-payments.update')->middleware('hasPermission:hub_payment_delete');


                Route::get('branches/{city}', [HubPaymentRequestController::class, 'getBranchesByCity'])->name('branches.by-city');
                ...
                // web.php mein add karein
                Route::get('get-branch-rates/{branchId}', [HubPaymentRequestController::class, 'getBranchRates'])->name('get.branch.rates');
                Route::get('/get-request-by-tracking/{tracking}', [HubPaymentRequestController::class, 'getRequestByTracking'])
                    ->name('get.request.by.tracking');
                // Get all branches for IN request
                ...
                Route::get('hub-branch-payments/{id}/edit', [HubPaymentRequestController::class, 'branchedit'])->name('hub-branch-payments.edit');

                // Route::get('/branch/{id}/edit', [HubPaymentRequestController::class, 'branchedit']) ->name('hub.branch.payment.edit');

                Route::delete('hub-branch-payments/{id}', [HubPaymentRequestController::class, 'destroy'])->name('hub-branch-payments.destroy');
                Route::delete('hub/payment-request/delete/{id}', [HubPaymentRequestController::class, 'branch_delete'])->name('hub-branch-payments.destroy')->middleware('hasPermission:hub_payment_request_delete');
		// Hub in charges
		

		Route::get('/get-state-by-city', [HubPaymentRequestController::class, 'getStateByCity'])->name('get.state.by.city');
                // routes/web.php या api.php 
                Route::get('/get-cities-suggestions', [HubPaymentRequestController::class, 'getCitiesSuggestions'])->name('get.cities.suggestions');



                Route::get('/hub-panel/payment-requests', [HubPaymentRequestController::class, 'index'])->name('hub-panel.payment-request.index');
                Route::get('/hub-panel/payment-requests/index', [HubPaymentRequestController::class, 'index_payment']);
                ...
                Route::get('merchant/{id}/parcel-download', [MerchantController::class, 'downloadParcels'])->name('merchant.parcel.download');
                ...
                Route::get('/get-branch-rate', [ParcelController::class, 'getBranchRate'])->name('parcel.getBranchRate');
                Route::get('/get-branch-rate-multiple', [ParcelController::class, 'getBranchRatemultiple'])->name('parcel.getBranchRatemultiple');
                Route::get('parcel/create_multiple', [ParcelController::class, 'createMultiple'])->name('parcel.create_multiple')->middleware('hasPermission:parcel_create');
                // Route::post('parcel/create_multiple',                [ParcelController::class, 'Multiple'])->name('parcel.multiple')->middleware('hasPermission:parcel_create');
                Route::post('/parcels/multiple', [ParcelController::class, 'storeMultiple'])->name('parcel.multiple');
                Route::get('/parcel/transport-price', [ParcelController::class, 'getTransportPrice'])
                    ->name('parcel.transport.price');
                ...
                Route::get('parcel/multiple/print/label/Estimate', [ParcelController::class, 'parcelMultiplePrintLabelEstimate'])->name('parcel.multiple.print-label-estimate');
                Route::get('parcel/multiple/print/label/perday', [ParcelController::class, 'parcelPerDay'])->name('parcel.multiple.print-label-perday');
                Route::get('parcel/multiple/print-label/info', [ParcelController::class, 'printLabelInfo'])->name('parcel.multiple.print-label-info');
                Route::get('parcel/multiple/print-label/orderinfo', [ParcelController::class, 'printLabelorderinfo'])->name('parcel.multiple.print-label-orderinfo');
                Route::get('parcel/multiple/print-label/order', [ParcelController::class, 'printLabelorder'])->name('parcel.multiple.print-label-order');
                ...
                Route::get('/merchant/branches', [ParcelController::class, 'getBranches'])->name('parcel.merchant.branch');
                ...
                Route::get('get-merchant-cod', [parcelController::class, 'getMerchantCod'])->name('get.merchant.cod');
                ...
                Route::get('hub-branch-payments/{id}/invoice', [HubController::class, 'branchInvoice'])->name('hub-branch-payments.invoice')->middleware('hasPermission:hub_payment_request_read');
