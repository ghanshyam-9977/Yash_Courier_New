...
class InstallerController extends Controller
{
   ...
   public function finish(Request $request){
    ...
    //                 case 403: return "The Mexdy token is missing the required permission for this script. Please contact to Mexdy.";
    //                 case 401: return "The Mexdy token is missing the required permission for this script. Please contact to Mexdy.";
    //             } 
    //             if ($responseCode !== 200) {
